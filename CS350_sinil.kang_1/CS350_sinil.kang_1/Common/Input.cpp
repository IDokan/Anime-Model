...
glm::vec2 Input::GetPresentMousePosition() const noexcept
{
	return presentMousePosition;
}

void Input::SetPresentMousePosition(const glm::vec2& mousePosition_) noexcept
{
...
void Input::SetMousePos(GLFWwindow* window, float xPos, float yPos)
{
	int x;
	int y;
